...
Product product1 = {name: "Apples", productId: 101, category: "Food", price: "$1.49 / lb" };
Product product2 = {name: "Macaroni & Cheese", productId: 151, category: "Food", price: "$7.69" };
Product product3 = {name: "ABC Smart TV", productId: 301, category: "Electronics", price: "$399.99" };
Product product4 = {name: "Motor Oil", productId: 401, category: "Automobile", price: "$22.88" };
Product product5 = {name: "Floral Sleeveless Blouse", productId: 501, category: "Clothing", price: "$21.50" };
...
service products on new http:Listener(9090) {
    ...
    resource function getProducts(http:Caller caller, http:Request req) {
        ...
        foreach var (k, product) in productsList {
            ...
            json jProduct = {name: product.name, id: product.productId, category: product.category, price: product.price};
